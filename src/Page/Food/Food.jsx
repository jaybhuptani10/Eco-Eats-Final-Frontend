        ...
        <div className="food-left">
          ...
          <div className="food-down">
            ...
            <div className="info-right">
              <p>
                Register to become a donor and help someone by not wasting food
                and giving them to needy
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="intro">
        ...
        <div className="intro-para">
          <p>
            ...
            underprivileged by facilitating the donation of surplus food through
          ...
          <ul>
            ...
            <li>
              The designated NGO will then proceed to the specified location to
              gather the surplus food items
            </li>
            <li>
